...
\null\hfill\includegraphics[width=0.65\textwidth]{my_photo.png}\hfill\null

\vspace*{0.5ex}

\headleft{Profile}
Engineer with strong leadership qualities and a high result-oriented mindset.
Ability to work under pressure allows rapid adaptation to unforeseen changes and finding effective solutions in critical situations.
